...
- M12 migration `m12_0015`; capital depletion, regeneration trajectories, and restoration measures are available for isolated tests. No recovered V1 populations are imported.
